...
//   // console.log(req.body); { username: 1, festival_id: 24 }
//   console.log("addpick",req.body);
// res.send("good")
//   // 받아온 username와 festival_id로 데이터 저장해주세욥
...
//   console.log(req.body); //{ username: 1, passwordCheck: 'aa' }
//   res.json({message:"ok"})
// })

// router.get('/pick/:username', (req, res) => {
//   const username = req.params
//   console.log('get picked festival',username); //{ username: '1' }
...
//   console.log('deletepick',req.body); //delete { username: 1, festival_id: 11 }
//   // db에 삭제 처리 해주세욥
//   res.send("good")
// })
...
//   // id는 review table의 고유 id(pk) 입니다. api문서에 festival_id랑 username 요렇게 보내주기로 되어있는데
//   // username는 토큰에 이미 담겨져서 오므로 토큰 검증으로 username를 얻을 수 있어 client에서 보내줄 필요가 없고, username랑 festival_id로 조인해서 찾는거보다 review table의 고유아이디를 프론트에서 백으로 바로 보내주어 백에서 더 간편하게 review table만 조회하여 삭제할 수 있습니다.
